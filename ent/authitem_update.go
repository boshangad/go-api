...
// Where appends a list predicates to the AuthItemUpdate builder.
...
func (aiuo *AuthItemUpdateOne) Select(field string, fields ...string) *AuthItemUpdateOne {
