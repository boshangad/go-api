...
// The AppOptionFunc type is an adapter to allow the use of ordinary
// function as AppOption mutator.
type AppOptionFunc func(context.Context, *ent.AppOptionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AppOptionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AppOptionMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AppOptionMutation", m)
	}
	return f(ctx, mv)
}
...
// The AppUserLoginLogFunc type is an adapter to allow the use of ordinary
// function as AppUserLoginLog mutator.
type AppUserLoginLogFunc func(context.Context, *ent.AppUserLoginLogMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AppUserLoginLogFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AppUserLoginLogMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AppUserLoginLogMutation", m)
	}
	return f(ctx, mv)
}

// The AppUserTokenFunc type is an adapter to allow the use of ordinary
// function as AppUserToken mutator.
type AppUserTokenFunc func(context.Context, *ent.AppUserTokenMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AppUserTokenFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AppUserTokenMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AppUserTokenMutation", m)
	}
	return f(ctx, mv)
}
...
// Mutate calls f(ctx, m).
func (f AuthAssgimentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AuthAssgimentMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AuthAssgimentMutation", m)
	}
	return f(ctx, mv)
}
...
// The AuthItemChildFunc type is an adapter to allow the use of ordinary
// function as AuthItemChild mutator.
type AuthItemChildFunc func(context.Context, *ent.AuthItemChildMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AuthItemChildFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AuthItemChildMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AuthItemChildMutation", m)
	}
	return f(ctx, mv)
}
...
// The AuthRuleFunc type is an adapter to allow the use of ordinary
// function as AuthRule mutator.
type AuthRuleFunc func(context.Context, *ent.AuthRuleMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AuthRuleFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AuthRuleMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AuthRuleMutation", m)
	}
	return f(ctx, mv)
}
